...
#define ENERGEST_CONF_ON      1 //edited by dongbo huang:1, default:0
#endif
...
#define UART0_CONF_WITH_INPUT 1//edited by dongbo huang: 1 , default: 0
#endif
...
#define ADC_SENSOR_CONF_ON      1//edited by dongbo huang: 1 ,defaulte: 0
#endif
#define TEMP_SENSOR_CONF_ON     1  /* Temperature */
#define VDD_SENSOR_CONF_ON      1  /* Supply Voltage */
#define BATTERY_SENSOR_CONF_ON  1  /* Battery */  //edited by dongbo huang: 1, default:0

/* Low Power Modes - We only support PM0/Idle and PM1 */
#ifndef LPM_CONF_MODE
#define LPM_CONF_MODE         2 /* 0: no LPM, 1: MCU IDLE, 2: Drop to PM1 */
#endif
...
#define VIZTOOL_CONF_ON        0    //edited by dongbo huang: 0 default:1
...
#if UIP_CONF_IPV6
#define NETSTACK_CONF_NETWORK sicslowpan_driver//edited by dongbo huang: rime_driver, default: sicslowpan_driver
#else
...
#define NETSTACK_CONF_MAC     nullmac_driver //edited by dongbo huang: nullmac_driver, default: csma_driver
#endif

#ifndef NETSTACK_CONF_RDC
#define NETSTACK_CONF_RDC     nullrdc_driver//edited by dongbo huang: contikimac_driver, default: nullrdc_driver
...
#define RIMEADDR_CONF_SIZE                   2            //edited by dongbo huang: 2 ,default: 8
